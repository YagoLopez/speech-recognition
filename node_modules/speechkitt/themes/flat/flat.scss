...
$toggleButtonWidth: 50px !default;
$toggleButtonHeight: 50px !default;
$buttonColor1: #2980B9 !default;
$buttonColor2: #3498DB !default;
$listeningBoxColor: #2980B9 !default;
$instructionColor: #fff !default;
...
#skitt-ui {
  ...
  background-color: $listeningBoxColor;
  z-index: 200;
...
#skitt-toggle-button {
  ...
  background-position: $toggleButtonHeight * 0.14 $toggleButtonWidth * 0.12;
...
.skitt-ui--listening #skitt-listening-text {
  ...
  margin: 0 $toggleButtonWidth/2 0 15px;
}
...
@media (max-width: 1200px) and (orientation: portrait)  {
  $sizeMultipliers: 2.5;
  #skitt-ui {
    border-radius: $toggleButtonWidth * $sizeMultipliers / 2;
    font-size: 35px;
    height: $toggleButtonHeight * $sizeMultipliers;
  }
  #skitt-toggle-button {
    width: $toggleButtonWidth * $sizeMultipliers;
    height: $toggleButtonHeight * $sizeMultipliers;
    background-position: $toggleButtonHeight * $sizeMultipliers * 0.14 $toggleButtonWidth * $sizeMultipliers * 0.12;
  }
  #skitt-listening-box {
    line-height: $toggleButtonHeight * $sizeMultipliers;
  }
}
